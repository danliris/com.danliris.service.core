...
namespace Com.DanLiris.Service.Core.Test.Controllers.DesignMotiveTest
{
    ...
    class DesignMotiveBasicTest
    {
        ...
        {
            DesignMotive design = await DataUtil.GetTestDataAsync();
            DesignMotiveViewModel VM = Service.MapToViewModel(design);
        ...
        {
            DesignMotive buyer = await DataUtil.GetTestDataAsync();
            DesignMotiveViewModel VM = Service.MapToViewModel(buyer);
