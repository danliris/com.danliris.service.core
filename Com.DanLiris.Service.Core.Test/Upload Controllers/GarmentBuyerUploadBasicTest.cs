...
namespace Com.DanLiris.Service.Core.Test.Controllers.Upload
{
    ...
    public class GarmentBuyerUploadBasicTest
    {
        ...
        public async Task Should_Success_Upload_CSV()
        {
            ...
            string content = $"{guid},Nama,Alamat,Kota,Afghanistan,NPWP,Lokal,Kontak,1";
        ...
        public async Task Should_Success_Upload_CSV_Using_Memory_Stream()
        {
            ...
            string guid = Guid.NewGuid().ToString();
            string header = "Kode Buyer,Nama,Alamat,Kota,Negara,NPWP,Jenis Buyer,Kontak,Tempo";
            string content1 = "AAA,Nama,Alamat,Kota,Afghanistan,NPWP,Lokal,Kontak,1";
            string content2 = "AAA,Nama,Alamat,Kota,Afghanistan,NPWP,Lokal,Kontak,1";
