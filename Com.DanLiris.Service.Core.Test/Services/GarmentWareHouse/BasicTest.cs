...
namespace Com.DanLiris.Service.Core.Test.Services.GarmentWareHouse
{
    public class BasicTest
    {
        private const string ENTITY = "GarmentWareHouse";
        ...
        private GarmentWareHouseDataUtil _dataUtil(GarmentWareHouseService service)
        {
            return new GarmentWareHouseDataUtil(service);
        }
        ...
        {
            var service = new GarmentWareHouseService(GetServiceProvider().Object, _dbContext(GetCurrentMethod()));
        ...
        public void Validate_ViewModel()
        {
            ...
            var viewModel = new GarmentWareHouseViewModel();
        ...
        public async void Validate_ViewModel_Duplicate()
        {
            ...
            var service = new GarmentWareHouseService(serviceProvider.Object, _dbContext(GetCurrentMethod()));
            serviceProvider.Setup(s => s.GetService(typeof(IGarmentWareHouseService)))
                .Returns(service);
