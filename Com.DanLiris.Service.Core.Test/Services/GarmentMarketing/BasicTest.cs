...
namespace Com.DanLiris.Service.Core.Test.Services.GarmentMarketing
{
    public class BasicTest
    {
        private const string ENTITY = "GarmentMarketing";
        ...
        private GarmentMarketingDataUtil _dataUtil(GarmentMarketingService service)
        {
            return new GarmentMarketingDataUtil(service);
        }
        ...
        {
            var service = new GarmentMarketingService(GetServiceProvider().Object, _dbContext(GetCurrentMethod()));
        ...
        public void Validate_ViewModel()
        {
            ...
            var viewModel = new GarmentMarketingViewModel();
        ...
        public async void Validate_ViewModel_Duplicate()
        {
            ...
            var service = new GarmentMarketingService(serviceProvider.Object, _dbContext(GetCurrentMethod()));
            serviceProvider.Setup(s => s.GetService(typeof(IGarmentMarketingService)))
                .Returns(service);
